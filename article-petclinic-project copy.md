# Building a Full-Stack PetClinic from Scratch: TypeScript, React 19, Express 5 & Modern Auth

I rebuilt the classic **Spring PetClinic** application — the most well-known demo app in the Java ecosystem — entirely in **TypeScript**, from the ground up. No Java. No Spring. Just a modern full-stack TypeScript application with a beautiful UI, production-grade authentication, and an AI chat assistant.

Here's how I built it and what I learned along the way.

---

## Why Rebuild PetClinic?

The original [Spring PetClinic](https://github.com/spring-projects/spring-petclinic) has been the go-to sample app for Java developers since 2003. It demonstrates how to build a CRUD application with owners, pets, veterinarians, and visits.

But I wanted to answer a question: **What does PetClinic look like when built with the modern TypeScript ecosystem?**

Not a port. Not a wrapper. A complete rethink — using the best tools available in 2025:
...
The backend is a REST API serving the classic PetClinic schema: **owners, pets, vets, specialties, and visits**. Key decisions:
...
- **AI Chat Assistant** — Already built and integrated (see my separate article on that)
...
The Spring PetClinic taught a generation of Java developers how to build web apps. I hope this TypeScript version can do the same for the next generation — showing that you can build a production-quality full-stack app with modern tools, clean architecture, and attention to detail.

**The code is on GitHub.** Star it, fork it, break it, make it yours.

---

*Built with TypeScript, powered by curiosity.*
